...
const todoItemsAtom = atom<Todo[]>({
  ...
  default: [
    ...
    {
      id: '2',
      title: 'Learn Recoil states',
      completed: false,
      createdAt: new Date(),
      updatedAt: new Date(),
      priority: 'high',
      tags: ['learning', 'recoil'],
    },
    {
      id: '3',
      title: 'Master Recoil state',
      completed: false,
      createdAt: new Date(),
      updatedAt: new Date(),
      priority: 'medium',
      tags: ['learning', 'recoil', 'mastery'],
    },
  ],
});
  ...
  return (
    <div ref={ref} className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full mx-4">
      <div className="text-center">
        ...
        <div className="text-sm text-gray-500">Using Recoil state management</div>
      </div>
    </div>
  );
};
...
const TodoApp = () => {
  ...
  return (
    <div ref={ref} className="bg-slate-900 rounded-2xl shadow-xl max-w-md w-full mx-4">
      <div className="p-4">
        <h3 className="font-semibold text-slate-200 flex-1 text-xl mb-10 text-center">Recoil Todo List</h3>
        <TodoForm />
        <TodoList />
      </div>
      <TodoStats />
...
const TodoList = () => {
  const todoItems = useRecoilValue(todoItemsAtom);
